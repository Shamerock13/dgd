...
from . import price_alert_models  # noqa: F401
...
from .price_alert_routes import router as price_alert_router
...
research_router.routes.extend(price_alert_router.routes)
research_router.routes.extend(price_source_review_router.routes)
